...
def compare_pid(mto_df, piping_class):
    ...
    # Aquí hay un limpiador que devuelve un archivo agrupado, con cantidades y con tags asiganos (aquí se le pregunta al usaurio en caso de que hayan más válvulas)
    ...
    # Modificar en el MTO, SUMARIO, MR y HD las válulas que cuenten con locking device
