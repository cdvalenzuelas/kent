...
def pre_manufacturing():
    ...
    co_df.drop(['common_index', 'MANUFACTURING_CODE', 'MANUFACTURING_TITLE',
                'MANUFACTURING_DESCRIPTION', 'TOTAL_WEIGHT'], inplace=True, axis=1)
